...
int main()
{
  ...
  printf("[test_looptiming.c] R5 loop initializing...\n");
  ...
  *gpio_cam = 0xff; // TODO: move this into camera init too
  ...
  IMX219_Config cam0 = {
    .reqId = CAMERA0,
    .i2c_channel = 3,
    .baseaddr = XPAR_CAM0_CSIRX_BASEADDR,
...
*/
    ...
    // Does this take substantial time?
    gpio_flag = gpio_flag ^ 0x08;
    *gpio_cam = gpio_flag; // Toggle one of the unused pins so we can watch the loop time
  }
