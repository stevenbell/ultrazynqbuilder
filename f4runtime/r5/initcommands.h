...
{4,0x01,0x2A,0x18,0x00}, // EXCK_FREQ = 0x1800 [24.00 MHz]
{3,0x01,0x57,0x00,0},    // ANA_GAIN_GLOBAL_A: 0 (unity gain)
...
{4,0x01,0x6C,0x06,0x68}, // x_output_size: 0x668 = 1640 (result with x2 binning)
