...
int main(int argc, char* argv[])
{
  ...
  uint32_t* data = (uint32_t*) mmap(NULL, buf.stride * buf.height * buf.depth,
  ...
  data = (uint32_t*) mmap(NULL, buf.stride * buf.height * buf.depth,
  ...
  uint32_t* rawdata = (uint32_t*) mmap(NULL, buf.stride * buf.height * buf.depth,
